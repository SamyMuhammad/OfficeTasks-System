    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create-form-element" action="{{ route('admin.expense-types.store') }}" method="POST">
                    @csrf
...
<script>
    function editCategory(itemId) {
        var update_route = "{{ route('admin.expense-types.update', ':id') }}";
        update_route = update_route.replace(':id', itemId);
        $('#edit-form-element').attr('action', update_route);

        var edit_route = "{{ route('admin.expense-types.edit', ':id') }}";
