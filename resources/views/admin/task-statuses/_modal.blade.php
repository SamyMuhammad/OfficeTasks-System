    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="create-form-element" action="{{ route('admin.task-statuses.store') }}" method="POST">
                    @csrf
...
@section('extra-js')
<script>
    function editTaskStatus(itemId) {
        var update_route = "{{ route('admin.task-statuses.update', ':id') }}";
        update_route = update_route.replace(':id', itemId);
        $('#edit-form-element').attr('action', update_route);

        var edit_route = "{{ route('admin.task-statuses.edit', ':id') }}";
